                    ...
                    <div className="col-span-12">
                        <div className="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div className="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <Link to='/user/add' className="inline-flex items-center justify-center px-3 py-2 font-medium text-white transition duration-200 border rounded-md shadow-sm cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 bg-primary border-primary">
                        ...
                        <div className="mt-3.5 flex flex-col gap-8">
                            <div className="flex flex-col box box--stacked">
                                ...
                                <div className="overflow-auto xl:overflow-visible">
                                    {loading ? (
                                        <div className="py-5 text-center">Loading users...</div>
                                    ) : (
                                        <table className="w-full text-left border-b border-slate-200/60">
                                            ...
                                            <tbody>
                                                {currentUsers.map((user) => (
                                                    <tr key={user.id} className="[&_td]:last:border-b-0">
                                                        ...
                                                        <td className="relative px-5 py-4 border-b border-dashed">
                                                            <div className="flex items-center justify-center">
                                                                <div className="relative h-5">
                                                                    ...
                                                                    <div className={`dropdown-menu absolute right-0 mt-2 z-[9999] ${dropdownOpen === user.id ? 'block' : 'hidden'}`}>
