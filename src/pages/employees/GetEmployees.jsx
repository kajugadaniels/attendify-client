                    ...
                    <div className="col-span-12">
                        <div className="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div className="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <Link to='/employee/add' className="inline-flex items-center justify-center px-3 py-2 font-medium text-white transition duration-200 border rounded-md shadow-sm cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 bg-primary border-primary">
                                        ...
                                        <table className="w-full text-left border-b border-slate-200/60">
                                            ...
                                            <tbody>
                                                {currentEmployees.map((employee) => (
                                                    <tr key={employee.id} className="[&_td]:last:border-b-0">
                                                            ...
                                                            <div className="flex items-center">
                                                                <div className="ml-3.5">
                                                                    ...
                                                                    <div className="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                                                        National ID: <span className="font-bold">{employee.nid}</span>
                                                                    </div>
                                                                    <div className="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                                                        RSSB Number: <span className="font-bold">{employee.rssb_number}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="relative px-5 py-4 border-b border-dashed">
                                                            <div className="flex items-center justify-center">
                                                                <div className="relative h-5">
                                                                    ...
                                                                    <div className={`dropdown-menu absolute right-0 mt-2 z-[9999] ${dropdownOpen === employee.id ? 'block' : 'hidden'}`}>
